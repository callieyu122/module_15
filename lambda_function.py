...
def recommend_portfolio(intent_request):
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            based on the information you provided, our investment descision is as follows: {}
            """.format(
...
def validate_data(age, investment_amount, intent_request):
       ...
       age = parse_int(
        ...
        if age > 65:
            return build_validation_result(
                False,
                "age",
                "You must be younger than 65 in order to qualify."
                )
        elif age < 0:
            return build_validation_result(
                False,
    ...
    if investment_amount is not None:
        ...
        if last_funding < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "You must have a minimum inital investment of 5000 to qualify. "
            )
    return build_validation_result(True, None, None)

def risk_level(loan_amount):
    """
    Returns a risk level based on the user input.
    """
    risk_level = {
        "none": "With your selected risk level, your investment stretegy should be in 100% bonds (AGG), 0% equities (SPY)",
        "low":"With your selected risk level, your investment stretegy should be 60% bonds (AGG), 40% equities (SPY)",
        "medium":"With your selected risk level, your investment stretegy should be 40% bonds (AGG), 60% equities (SPY)",
        "high": "With your selected risk level, your investment stretegy should be 20% bonds (AGG), 80% equities (SPY)"
    }
